...
while (continuar)
{
    ...
    Console.WriteLine("8 - multiplos de 3 entre 0 e 10");
    Console.WriteLine("9 - calculo de fatorial entre 1 e 10");
...
void Conversor()
{
    ...
    Console.WriteLine($"O valor {metros}m corresponde a {metrosMilimetros.Converter(metros)} milimetros ");

}

void multiplo()
{
    multiplosde3 calculadora = new multiplosde3();
    List<int> resultados = calculadora.multiplo(100);
